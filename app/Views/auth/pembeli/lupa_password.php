...
<body>
    ...
    <div class="auth-card">
        ...
        <form method="post" action="<?= base_url('lupa-password') ?>" autocomplete="off" novalidate>
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" id="email" name="email" value="" placeholder="Masukkan email terdaftar Anda" autocomplete="off" required maxlength="255">
                </div>
            </div>

            <button type="submit" class="btn-primary">Kirim Kode OTP Reset</button>
        </form>

        <div class="auth-footer">
            Ingat kata sandi? <a href="<?= base_url('login') ?>">Kembali ke Halaman Masuk</a>
        </div>
    </div>
