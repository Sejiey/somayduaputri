...
<head>
    ...
    <title><?= esc($title ?? 'Booking Berhasil — Siomay Dua Putri') ?></title>
...
<body>
    ...
    <div class="main-card">
        ...
        <h1 class="page-heading">Booking Berhasil!</h1>
        ...
        <div class="info-card-box">
            <div class="info-group">
                ...
                <div class="info-code">#<?= esc($booking['kode_booking']) ?></div>
            </div>

            <div class="info-group">
                <span class="info-label">Tanggal Acara</span>
                <div class="info-val"><?= date('d F Y', strtotime($booking['tanggal_acara'])) ?></div>
            </div>
