...
<style>
    ...
    .hiw-actions {
        display: flex;
        flex-direction: row; /* Diubah menjadi row agar berdampingan */
        gap: 12px;
    }
    .btn-hiw {
        display: flex;
        ...
        border-radius: 8px;
        font-weight: 600;
        font-size: 0.85rem; /* Diperkecil agar rapi */
        cursor: pointer;
        transition: all var(--t-fast);
        text-decoration: none;
        width: auto; /* Mengikuti ukuran konten (tidak 100% lagi) */
        font-family: 'Poppins', sans-serif;
    }
    .btn-hiw.solid {
    ...
    .hiw-image {
        ...
        z-index: 10;
        width: 100%;
        max-width: 580px; /* DIPERBESAR dari 480px ke 580px */
        object-fit: contain;
        filter: drop-shadow(0 20px 40px rgba(0,0,0,0.15));
        /* Animasi mengambang ditambahkan di sini */
    ...
    @media (max-width: 992px) {
        ...
        .hiw-image {
            max-width: 380px; /* Gambar HP juga sedikit diperbesar */
        }
        .hiw-text {
            max-width: 100%;
        }
        ...
        .hiw-actions {
            max-width: 100%;
            flex-direction: row; /* Tetap berdampingan di HP */
            justify-content: center;
        }
    }
</style>
...
<div class="hiw-section fade-up">
    ...
    <div class="hiw-container hiw-grid">
        ...
        <!-- Kolom Teks (Kiri) -->
        <div class="hiw-text">
            <h1 class="hiw-heading">Atur Jadwal Pesanan Acara Anda</h1>
            
            <p class="hiw-desc">
                Layanan pesanan porsi besar fleksibel. Tentukan jadwal untuk hari H acara Anda dengan kapasitas jumlah banyak. Praktis, terjamin, dan aman.
            </p>
            ...
            <div class="hiw-card">
                <div class="hiw-step">
                    ...
                    <div class="hiw-step-text">
                        <h4>Pilih Waktu</h4>
                        <p>Tentukan tanggal dan jam kesiapan pesanan jauh-jauh hari agar tepat waktu saat acara Anda dimulai.</p>
                    </div>
                </div>
                ...
                <div class="hiw-step">
                    ...
                    <div class="hiw-step-text">
                        ...
                        <p>Pesanan porsi besar dapat diambil langsung di tempat kami atau diantarkan menggunakan layanan Maxim.</p>
                    </div>
                </div>
            ...
            <div class="hiw-actions">
                <a href="<?= base_url('pesan-stand/form') ?>" class="btn-hiw solid">
                    Mulai Pesan
                </a>
        ...
        <div class="hiw-visual">
            <img src="<?= base_url('icon_2.png') ?>" alt="Ilustrasi Pesanan" class="hiw-image" onerror="this.src='<?= base_url('assets/img/icon_1.png') ?>'">
        </div>
